...
Запись экрана сразу в ссылку, с расшифровкой. Для черновиков и объяснений, а не для финального ролика.
...
Стандарт записи экрана и стрима, бесплатно и на всех платформах. Сцены, источники, виртуальная камера.
...
`screen-recording` `streaming` `local`
...
Запись экрана с автоматическим зумом на курсор и плавными движениями. Тот самый вид «дорогого» скринкаста.
