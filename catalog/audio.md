...
Оркестровые и кинематографичные темы. Заточен под саундтрек, а не под биты.
...
`music` `orchestral` `cinematic`

---

## [AssemblyAI](https://www.assemblyai.com/)

Транскрипция с разделением говорящих и главами из коробки. Русский держит уверенно.
...
Бесплатный аудиоредактор с пакетными сценариями. Ручная доводка после автоматики.
...
Сотни тысяч треков и звуков поштучно, без подписки. Разовая лицензия под конкретный ролик.
...
Открытая генерация звуковых эффектов по описанию. SFX, которого нет ни в одной библиотеке.
...
| **Цена** | 🔵 open source |
| **Из агента** | `CLI` |
| **Исходники** | https://github.com/haoheliu/AudioLDM |

`sfx` `open-weights` `local`
...
33 тысячи звуков из архива BBC, бесплатно для личных и учебных проектов. Читай условия для коммерции.
...
Фоновая музыка под заданное настроение и хронометраж, с понятными правами на использование.
...
Фоновая музыка от одного автора — отсюда узнаваемая ровность. Бесплатно с указанием авторства.
...
Синтез звука кодом, с историей с 1986 года. Для полностью процедурного саунд-дизайна.
...
`synthesis` `procedural` `cli`

---

## [Deepgram](https://deepgram.com/)

Быстрая транскрипция по API с низкой задержкой. Дешевле AssemblyAI на объёме.
...
Музыка подбирается по сцене и настроению, а не по жанру. Удобно, когда не знаешь музыкальных терминов.
...
Музыка под Creative Commons от живых исполнителей. Звучит человечнее генерации.
...
Генеративная музыка потоком и по API. Бесконечный фон нужной длины без склейки петель.
...
Полноценная DAW за цену подписки на месяц облачного сервиса. Бессрочная лицензия, честный триал.
...
Меняет тембр в готовой записи, сохраняя вашу интонацию и тайминг. Не синтез с нуля — конверсия.
...
| **Цена** | 🔵 open source |
| **Из агента** | `CLI` |
| **Исходники** | https://github.com/RVC-Project/Retrieval-based-Voice-Conversion-WebUI |

`voice-conversion` `local`

---

## [Silero VAD](https://github.com/snakers4/silero-vad)

Определяет, где в дорожке речь, а где тишина. Кирпич под автонарезку и вырезание пауз.
...
| **Цена** | 🔵 open source |
| **Из агента** | `CLI` |
| **Исходники** | https://github.com/snakers4/silero-vad |
...
Генерация музыки с правами на коммерческое использование результата.
...
Генерация музыки с ручной правкой структуры: где куплет, где нарастание. Ложится в тайминг сцен.
...
Музыка, специально расчищенная от копирайт-претензий YouTube. Бесплатный тариф с атрибуцией.
