...
TouchDesigner в браузере: нодовая графика без установки, с экспортом в веб.
...
Каркас генеративных работ с экспортом секвенции кадров под нужный размер. Прямо стыкуется с ffmpeg.
...
| **Цена** | 🔵 open source |
| **Из агента** | `CLI` |
| **Исходники** | https://github.com/mattdesl/canvas-sketch |

`generative` `frames-export` `canvas`
...
Классический сборник генеративных приёмов с исходниками. Каталог идей, а не библиотека.
...
Живое кодирование визуалов прямо в браузере. Аудиореактивные фоны в несколько строк.
...
`live-coding` `audio-reactive` `browser`
...
C++ каркас для тяжёлой real-time графики. Берут, когда браузер уже не тянет.
...
Векторная графика на canvas с честными кривыми Безье. Для схем и рисованных линий.
...
Среда генеративной графики с экспортом кадров. Прародитель всего creative coding.
...
Огромная библиотека готовых GLSL-шейдеров с исходниками. Источник фонов, которых точно нет у других.
...
Учебник по фрагментным шейдерам с редактором в браузере. Отсюда начинают, если хочется своей процедурной графики.
...
Нодовая среда для аудиореактивной графики. Бесплатная версия ограничена 1280×1280 — для вертикалок хватает.
...
`nodes` `audio-reactive` `realtime`

---

## [Zdog](https://zzz.dog/)

Псевдо-3D на плоских формах, очень лёгкий. Милая объёмная иконка без всякого WebGL.
